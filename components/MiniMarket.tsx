  ...
  return (
    <div className="w-full relative lg:w-3/4">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-end pt-5 gap-5">
          <PrimaryBtnComponent
            ...
            <tbody className="bg-white divide-y divide-black  text-base">
              {projects.length === 0 ? (
                ...
                projects.map((project, index) => {
                  ...
                  return (
                    <tr key={index}>
                      <td className="xs-m:pr-14 pl-6 py-4">{project}</td>
      ...
      {showNewProject && (
        <div className="fixed top-28 h-fit md:h-fit shadow-btn-6 border-2 border-black bg-white md:top-32 right-0 mx-5 xs-m:w-3/4 lg:w-3/4 lg:max-w-5xl xs-m:mx-auto left-0 ">

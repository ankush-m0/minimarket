    ...
    <div className="flex flex-col w-[60%] border-2 border-black p-8 h-[fit-content] font-mono shadow-[rgba(0,0,0,1)_5px_5px_0px_1px] bg-white">
      ...
      <div className="flex flex-row justify-between">
        <div>
          ...
          <button className="p-2 text-black border-2 border-black bg-white shadow-[rgba(0,0,0,1)_3px_3px_0px_1px] py-2" onClick={() => setShowDeleteProject(true)}>
            Delete Project
          </button>
        </div>
        <button className="p-2 text-black border-2 border-black bg-white shadow-[rgba(0,0,0,1)_3px_3px_0px_1px] py-2" onClick={close}>
          Cancel
        </button>
      </div>
      {

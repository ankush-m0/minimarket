    ...
    <div className="flex flex-col mx-auto border-2 border-black p-8 h-fit text-black font-mono shadow-btn-6 bg-white">
      ...
      <div className="grid gap-10 md:grid-cols-2 ">
        ...
        <div className="flex flex-col border-2 border-black rounded-xl p-8 ">
          ...
          <button
            className="text-xs w-[35%] place-self-end border border-slate-300 rounded-full p-1 mb-4"
          ...
          <div className="flex flex-row justify-between border border-gray-200 bg-gray-100 px-5 py-2 rounded-md mb-4">
            <button
              className="text-sm focus:bg-blue-600 focus:text-white py-2 px-4 rounded-md"
            ...
            <button
              className="text-sm focus:bg-blue-600 focus:text-white py-2 px-4 rounded-md"
              onClick={handleBrowseDetailsClick}
            >
              Browse Details
            </button>
          </div>
            ...
            <div>
              <div className="flex flex-row justify-between mb-4">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <p className="ms-3 text-sm font-medium text-black">
                    Crowd Fill
                  </p>
                </label>
              ...
              <div className="flex flex-col py-4 px-[10%] bg-gray-100 border border-gray-200 rounded-lg mb-4">
                ...
                <p className="place-self-end text-xs">
                  Transfer Tax is Unknown
                </p>
              </div>

...
export default function Sidebar() {
  return (
    <div className="flex flex-col ">
      <div className="border-b-2 border-black py-3 md:py-4">
      <Logo />
      </div>
      <div className="w-3/4 mx-auto">
        <div className="flex flex-col border-b border-black items-center">
        ...
        <div className="flex flex-col border-b border-black items-center mb-6">
          <button className="text-center font-bold my-5">
            REWARDS & SETTINGS
          </button>
          <div className="flex flex-col items-center mb-6 ">
